...
export default function AddCustom(props: Props) {
	...
	return (
		<div className={b()}>
			<ModalHeader title="Özel eğitmen ekle" />
			<div className={b('body')}>
				<Input legend="İsim" onChange={setName} value={name} />
				<Input legend="Çözüm" onChange={setSolution} value={solution} />
				<TextArea
					legend="Açıklama"
				...
				/>
				<TextArea
					legend="Alternatif çözümler"
					onChange={setAltSolutions}
					value={altSolutions}
					optional
					info="Bu çözümler ters çevrilecek ve karıştırmalar için kullanılacak. Her satırda bir tane"
				/>
				{data?.customTrainer?.copy_of_id ? null : (
					<Checkbox checked={privateChecked} text="Eğitmeni özel yap" onChange={onPrivateChange} />
				)}
				<HorizontalLine />
