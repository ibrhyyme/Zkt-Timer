	...
	return (
		<div className={b()}>
			...
			<ul>
				...
				<li>
					<p>
						...
						&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Zkt-Timer.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to Zkt-Timer, accessible from{' '}
						<a href="/" rel="external nofollow noopener" target="_blank">
							https://www.zkt-timer.io
						</a>
					</p>
				</li>
				<li>
			...
			<p>
				...
				admin@zkt-timer.io and include in Your notice a detailed description of the alleged infringement.
			</p>
			<p>
