...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    /// Ilk acilis retry'lari basarisiz olduktan sonra offline bundle'a yonlendir
    private func showOfflineFallback() {
        ...
        if currentUrl.contains("offline") { return }

        print("[ZKT] Tum retry'lar basarisiz, offline bundle yukleniyor")
        // Offline bundle varsa tam uygulamayi yukle, yoksa basit offline.html
        ...
        } else if let offlinePath = Bundle.main.path(forResource: "offline", ofType: "html", inDirectory: "public") {
