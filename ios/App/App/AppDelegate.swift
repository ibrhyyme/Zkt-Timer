...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Web yukleme dayanikliligi (offline sayfasi, retry, reachability) tek yerde
        // toplandi: ZKTBridgeViewController + NWPathMonitor. Burada artik first-launch
        // retry / stale offline-bundle fallback yok.
        return true
    }
